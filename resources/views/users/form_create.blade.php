   ...
   <div class="row row-cols-1">
    <div class="col-xs-12">
        <div class="form-group">
            ...
            <div class="col-md-6">
                <input id="input_crear" name="name" type="text" value="{{ old('name') }}" placeholder="Nombre" class="form-control">
        ...
        <div class="form-group">
            <span class="col-md-1 col-md-offset-2 text-center"><i class="fa fa-user bigicon"></i></span>
            <div class="col-md-6">
                <input id="input_crear" name="email" type="email" value="{{ old('email') }}" placeholder="Correo Electronico" class="form-control">
